...
if [ ! -f "$PHP_BIN" ]; then
    ...
    case "$OS-$ARCH" in
        ...
        Linux-aarch64|Linux-arm64) URL="https://dl.static-php.dev/static-php-cli/common/php-8.4.19-cli-linux-aarch64.tar.gz" ;;
        Linux-x86_64)  URL="https://dl.static-php.dev/static-php-cli/common/php-8.4.19-cli-linux-x86_64.tar.gz" ;;
